...
Note that this dataset is unrelated to
[`proxiscoutCannabis`](https://buchi-labortechnik-ag.github.io/proximetricsR/reference/proxiscoutCannabis.md),
which contains a different set of cannabis samples, measured with
ProxiScout devices over a different spectral range and accompanied by a
different set of reference variables. The two datasets share neither
samples nor reference values and cannot be combined.
